...
public class AutoCompleteDictionaryTrieTester {
	...
	public void myTests() {
		...
		//System.out.println("moje testy poczatek");
		AutoCompleteDictionaryTrie damian;
		damian = new AutoCompleteDictionaryTrie();
		damian.addWord("damian");
		damian.addWord("drunkman");
		damian.addWord("doktor");
		damian.addWord("data");
		damian.addWord("eliza");
		damian.addWord("dariusz");
		damian.addWord("danuta");
		damian.isWord("dam");
		//System.out.println(damian.isWord("dak"));
		//damian.printTree();
		//System.out.println("moje testy k");
	...
	public void testPredictCompletions()
	{
		...
		//System.out.println("tutaj spierdolone)");
